...
We only had lots of letters repeated lots of times:
...
If we count them, and look for corresponding ascii value, we had the following sequence:
|  Letter  |  N times  | Ascii value |
|----------|-----------|-------------|
|     a    |    102    |    f        |
|     b    |    108    |    l        |
|     c    |    97     |    a        |
